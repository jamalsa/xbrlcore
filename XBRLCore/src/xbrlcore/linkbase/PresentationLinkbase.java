...
public class PresentationLinkbase extends Linkbase {
	 ...
	 */
	public List getPresentationList(String taxonomyName, String extendedLinkRole)
	 ...
	 *         objects.
	 */
	public PresentationLinkbaseIterator iterator(String taxonomyName,
			String extendedLinkRole) throws XBRLCoreException {
		return new PresentationLinkbaseIterator(getPresentationList(
				taxonomyName, extendedLinkRole));
	}
	 ...
	 */
	public List getPresentationList(Concept concept, String extendedLinkRole) {
		if (extendedLinkRole == null) {
			extendedLinkRole = GeneralConstants.XBRL_LINKBASE_DEFAULT_LINKROLE;
		}
	 ...
	 */
	public PresentationLinkbaseIterator iterator(Concept concept,
			String extendedLinkRole) {
		return new PresentationLinkbaseIterator(getPresentationList(concept,
				extendedLinkRole));
	}
	 ...
	 * @return List of xbrlcore.linkbase.PresentationLinkbaseElement objects.
	 */
	public List getPresentationList(String taxonomyName)
			throws XBRLCoreException {
	...
	public PresentationLinkbaseIterator iterator(String taxonomyName)
			throws XBRLCoreException {
		return new PresentationLinkbaseIterator(
				getPresentationList(taxonomyName));
	}
